...
export function BrandLogo({ className, imageClassName, textClassName }: BrandLogoProps) {
  ...
  return (
    <span className={cn("inline-flex h-[50px] w-[198px] items-center gap-[8px]", className)}>
      {isDark ? (
        <>
          ...
          <span className={cn("flex min-w-0 flex-1 shrink-0 flex-col justify-center leading-none", textClassName)}>
